...
import 'package:crud_p4/main.dart';
...
class _EditState extends State<Edit> {
  ...
  void editData() {
    var url = Uri.parse(
        'http://192.168.43.218/latihan-api/backend-blog/update.php '); //update api calling
    http.post(url, body: {
  ...
  void initState() {
    title = TextEditingController(
        text: widget.list[widget.index]
            ['title']); //setting up the existing values in text editing control
